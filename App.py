...
def introduction_page():
    ...
    st.write("""The proposed project aims to develop an Optimized Intrusion Detection System (IDS) utilizing Machine Learning (ML) techniques along with Feature Selection. Securing computer systems and networks is of utmost importance in today's interconnected world. Traditional methods of intrusion detection are often insufficient, necessitating the use of advanced technologies. The Internet, mobile, e-commerce, PC-based communication, and information systems have become parts of daily life. The widespread usage of these systems makes communication easier, increases data transfer and information sharing, and improves life quality. However, these systems are vulnerable to various attacks, such as viruses, worms, and Trojan horses. Given the importance of these systems, it is crucial to identify and stop these attacks as soon as possible. Intrusion detection plays a crucial role in safeguarding systems and networks from unauthorized access, and this project aims to contribute significantly to this field. Machine learning serves as a powerful tool in intrusion detection due to its ability to learn and adapt to evolving threats. It can analyze large datasets and identify challenging patterns for traditional rule-based systems. For this project, we used the NUSW-NB 15 dataset, a widely recognized dataset in the field of intrusion detection.""")
